...
class TestContentDeduplication:
    ...
    def test_working_dir_content_seeded(self, tmp_path):
        ...
        # Real context files normally end in a newline. The seed and lazy-load
        # paths must hash the same bytes; stripping only one side silently
        # defeats the dedupe contract.
