...
SKYAI_BOOKNOW_CONTEXT_PRINCIPLE = (
    ...
    "резервация за ден/час с карта и без предварителен ваучер. Не въвеждай и не питай за "
    "BookNow рутинно. Избрани дата/час, платена сума, доплащане или потвърдена резервация "
    "сами не доказват BookNow. Приемай BookNow само ако клиентът го посочи или evidence ясно "
    "показва директна карта без ваучер; уточни само при конкретно съмнение, което променя отговора. "
    "Ако изпълнителят не проведе действителна BookNow резервация, парите ще бъдат възстановени."
)
