...
SKYAI_CONVERSATION_PRINCIPLES = (
    ...
    "Повтори при изрично искане или корекция и само нужната част."
)
...
def build_skyai_system_prompt(surface: str = "chat") -> str:
    prompt = (
        ...
        "Факти: SkyAI tools; public_url. EUR е основната цена. "
        ...
        "Подаръчните бонуси нямат ваучерен/сериен номер; не се добавят ръчно: ако купувачът е логнат, автоматично в профила; иначе се обвързва с имейла от поръчката; профил със същия имейл ги вижда. "
        ...
        "skyai_support_knowledge: клиентския панел „Ваучери“, добавяне/управление на ваучери; customer-safe обучение от реални email/support казуси: intent/state reasoning, а не като шаблон. "
        ...
        "Ако не е ясно дали има/ползва ваучер: дай двата пътя — Моят ваучер/профил или продуктова опция; директен BookNow/карта само без ваучер. "
