...
SKYAI_CONFIRMED_RESERVATION_CANCEL_PRINCIPLE = (
    ...
    "ако self-service е наличен. не измисляй универсален срок: cutoff/такси/липса на анулиране са "
    "условия на услуга/изпълнител и платформата ги прилага. Ако бутонът липсва/отказва/срокът е минал, "
    "насочи към екипа/изпълнителя за съдействие/изключение без обещание. Дръж анулирането отделно: "
    "след успешно анулиране и освобождаване на ваучера клиентът ползва Замени услуга/друго преживяване."
)
...
def build_skyai_system_prompt(surface: str = "chat") -> str:
    prompt = (
        ...
        "Помагаш за преживявания, подаръци, ваучери, BookNow и резервации. "
