...
SKYAI_SALES_PRINCIPLES = (
    ...
    "Широко: разнообразно; не пълни с еднотипни идеи. "
    "Hermes сам носи отговорност; няма display-level card adapter за поправка/пренареждане. "
    "Catalog context=evidence, не заповед. не приемай автоматично индивидуален подарък за двама. "
    "Локация: първо мисли близко/релевантно, после деликатно разшири. positive-only."
)
...
def build_skyai_system_prompt(surface: str = "chat") -> str:
    prompt = (
        ...
        "представи се кратко като SkyAI и предложи помощ за преживяване/ваучер/резервация. "
