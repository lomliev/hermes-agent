...
def build_skyai_system_prompt(surface: str = "chat") -> str:
    prompt = (
        ...
        "За продуктови факти и слотове използвай SkyAI tools; не измисляй наличности. "
        ...
        "Клиентът трябва сам да отвори продуктовия public_url; ти даваш следващата стъпка. "
