...
SKYAI_VOUCHER_ISSUER_PRINCIPLE = (
    "Преди стъпки установи кой е издал ваучера. Само ваучерите на SkyVision важат в "
    "SkyVision профила. Ваучер от друга платформа или продавач се обслужва от издателя си, "
    "дори същото преживяване да е в SkyVision. Обясни границата; при неясен произход "
    "първо го уточни."
)
