...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("approve", "Approve one pending exact operation by opaque ID", "Session",
               gateway_only=True, args_hint="<approval_id>", busy_policy="dispatch"),
    CommandDef("deny", "Deny one pending exact operation by opaque ID", "Session",
               gateway_only=True, args_hint="<approval_id> [reason]", busy_policy="dispatch"),
    ...
    CommandDef("yolo", "Toggle YOLO mode (bypass exact operation approvals)",
               "Configuration", busy_policy="dispatch"),
    CommandDef("approvals", "Show or set the persistent operation approval mode",
               "Configuration", args_hint="[manual|off]",
               subcommands=("manual", "off")),
