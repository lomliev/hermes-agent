...
def redact_terminal_output(output: str, *, force: bool = False) -> str:
    ...
    The policy is deliberately uniform and never interprets command text:
    ...
    if not output:
        return output
    return redact_sensitive_text(output, force=force, code_file=False)
