...
class SessionDB(SessionSearchMixin, SessionSchemaMixin, SessionPortabilityMixin):
    ...
    _serialize_session_model_config = staticmethod(
    ...
    def update_session_meta(
        ...
        """
        # This write bypasses the token queue, so prior deltas must land
        # before metadata is replaced.
        self.flush_token_counts()
        safe_model_config_json = _serialized_session_model_config(
            model_config_json,
            field="session.model_config",
    ...
    def update_session_model(self, session_id: str, model: str) -> None:
        ...
        """
        # Preserve accounting order before replacing the active model route.
        self.flush_token_counts()
        from gateway.api_execution_context import normalize_model_identifier
        ...
        *,
        ...
        for key, value in patch.items():
            if value is None:
                ...
                config[key] = value
        return _serialized_session_model_config(
            config,
            field="stored session.model_config",
        )
