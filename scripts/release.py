...
LEGACY_AUTHOR_MAP = {
    ...
    "DavidMetcalfe@users.noreply.github.com": "DavidMetcalfe",  # prefix-less noreply used by upstream sync commits
    ...
    "SJWATTS89@OUTLOOK.COM": "lEWFkRAD",  # upstream sync author mapping (gateway scheduled task hardening)
    "poli.koltsova@gmail.com": "wnuuee1",  # upstream sync author mapping (desktop tooltip styling)
    ...
    "christianpersico98@gmail.com": "chrispersico",  # upstream sync author mapping (docs web search instructions)
    ...
    "15791290+domtriola@users.noreply.github.com": "domtriola",  # PR #25424 contributor salvage
