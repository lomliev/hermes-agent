...
def cronjob(
    ...
    try:
        ...
        if normalized in {"run", "run_now", "trigger"}:
            ...
            # persisted. The primary model remains the semantic authority for
            # interpreting that context; no keyword classifier is applied.
...
registry.register(
    ...
    # Model routing is owner-owned configuration. The acting agent may manage
    # job behavior, but cannot pin or override the provider through this tool.
